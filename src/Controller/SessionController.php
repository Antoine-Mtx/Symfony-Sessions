...
class SessionController extends AbstractController
{
    ...
    /**
     * @Route("/session/{idSession}/addProgramme/{idModuleFormation}", name="add_programme_session")
     * @ParamConverter("session", options={"mapping": {"idSession": "id"}})
     * @ParamConverter("moduleFormation", options={"mapping": {"idModuleFormation": "id"}})
     */
    public function addProgramme(ManagerRegistry $doctrine, ModuleFormation $moduleFormation, Session $session, Request $request)
    {
        ...
        $programme->setModuleFormation($moduleFormation);
